...
const LoginForm = ({ onLogin }) => {
  ...
  return (
    <div className="login-full-width-wrapper">
      ...
      <style>{`.login-full-width-wrapper{background-color:#1b4d3e;min-height:100vh;width:100vw;display:flex;justify-content:center;align-items:center;font-family:'Segoe UI',sans-serif}.level-up-card{background:#fff;padding:40px;border-radius:24px;box-shadow:0 20px 60px rgba(0,0,0,.3);border-top:8px solid #fb8c00;text-align:center;width:400px}.form-title{color:#1b4d3e;font-size:24px;font-weight:800;margin-bottom:5px}.input-group{text-align:left;margin-bottom:20px}.input-label{display:block;font-weight:700;color:#444;margin-bottom:8px;font-size:14px}.farmer-input{width:100%;padding:15px;border:2px solid #eee;border-radius:12px;box-sizing:border-box;font-size:16px}.login-submit-btn{width:100%;padding:16px;background:#fb8c00;color:#fff;border:none;border-radius:12px;cursor:pointer;font-size:18px;font-weight:700}.login-submit-btn:hover{background:#ef6c00}.form-footer{margin-top:20px;display:flex;justify-content:space-between;font-size:14px}.form-footer a{color:#fb8c00;text-decoration:none;font-weight:600}`}</style>
    </div>
  );
};
